...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="dashboard.php" class="brand-link">
    <img src="company/logo.png" alt="Mankraft Barbershop" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">Manpkraft Barbershop</span>
  </a>
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      if ($query->rowCount() > 0) {
        foreach ($results as $row) {
          // Store user's permission in a session variable
          ...
          <div class="info">
            <a href="profile.php" class="d-block"><?php echo htmlentities($row->name); ?> <?php echo htmlentities($row->lastname); ?></a>
          </div>
          <?php
        }
      }
